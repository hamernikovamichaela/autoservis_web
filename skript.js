// === HERO SLIDESHOW ===
const images = [
  'img/Hero/IMG_2467.webp', // první (již nastavený v CSS)
...
let current = 1; // Začneme druhým obrázkem
let backgrounds = [bg1, bg2, bg3];
let showingBg = 0; // Aktuálně zobrazený background (bg--1)

function changeBackground() {
  const nextImage = images[current];

  // Skryjeme aktuální pozadí
  backgrounds[showingBg].style.opacity = '0';

  // Vybereme další pozadí a nastavíme obrázek
...
// Spustit slideshow každých 5 sekund
