// === HERO SLIDESHOW ===
const images = [
  'img/Hero/IMG_2467.webp', // první obrázek už je nastavený v CSS
...
let current = 1; // Začínáme druhým obrázkem
let backgrounds = [bg1, bg2, bg3];
let showingBg = 0;

// Funkce pro přepnutí obrázku
function changeBackground() {
  ...
  // Nastavíme další pozadí a obrázek
...
// Spustit slideshow pouze na desktopu
